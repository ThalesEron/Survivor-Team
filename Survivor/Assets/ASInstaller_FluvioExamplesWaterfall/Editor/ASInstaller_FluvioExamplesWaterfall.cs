// ASInstaller_FluvioExamplesWaterfall.cs
...
public static class ASInstaller_FluvioExamplesWaterfall
{
    #region Settings - Edit these
    // The display name for the package, shown to the user.
    internal static string _displayName = "Fluvio Examples: Waterfall";

    // A short description for interactive installation.
    internal static string _description =
        string.Format(
            "This wizard will install Fluvio Examples: Waterfall for your Unity version into your project. Please select one of the following options to continue.\n\nIf you exit this installer early, you can re-run it by going to {0}.",
            _menuItem.Replace("/", " > "));

    // Menu item, in case the installation window is closed.
    internal const string _menuItem = "Window/Fluvio/Install Fluvio Examples: Waterfall";
    ...
    const string _baseFolder = "ASInstaller_FluvioExamplesWaterfall";
    ...
    const string _packageName = "FluvioExamplesWaterfall";
    ...
    static ASInstaller_FluvioExamplesWaterfall()
    {
